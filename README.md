...
- **🧠 Wellbeing & Risk Analyzer:**  Analyzes wellbeing and churn risk signals across HR, surveys, and workload data. Combines sick leave, psychological safety, overtime, and engagement trends to detect burnout or retention risks and estimate absence and replacement costs.
- **📈 Skills & Growth Analyzer:** Evaluates skills coverage, learning activity, and motivation signals. Uses RAG over skill taxonomy and training catalogs to identify development gaps and recommend relevant learning paths.
- **⚙️ Delivery & Workload Analyzer:** Monitors delivery performance and workload using engineering and project data. Analyzes sprint completion, PR velocity, and meeting load to detect productivity risks and capacity constraints.
