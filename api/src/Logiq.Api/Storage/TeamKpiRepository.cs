...
public sealed class TeamKpiRepository(IOptions<StorageOptions> options) : ITeamKpiRepository
{
    ...
    public async Task<TeamKpis?> GetCurrentAsync(string teamId, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            var response = await _table.GetEntityAsync<TeamKpiSnapshotEntity>(teamId, CurrentRowKey, cancellationToken: cancellationToken);
    ...
    public async Task UpsertAsync(string teamId, TeamKpis kpis, TeamFinancials financials, CancellationToken cancellationToken = default)
    {
        await _table.CreateIfNotExistsAsync(cancellationToken);
        var entity = new TeamKpiSnapshotEntity
        {
            PartitionKey = teamId,
    ...
    {
        Wellbeing = new TeamKpiMetric { Score = e.WellbeingScore, Status = e.WellbeingStatus, Label = e.WellbeingLabel, Trend = e.WellbeingTrend, Description = e.WellbeingDescription },
        Skills = new TeamKpiMetric { Score = e.SkillsScore, Status = e.SkillsStatus, Label = e.SkillsLabel, Trend = e.SkillsTrend, Description = e.SkillsDescription },
        Motivation = new TeamKpiMetric { Score = e.MotivationScore, Status = e.MotivationStatus, Label = e.MotivationLabel, Trend = e.MotivationTrend, Description = e.MotivationDescription },
        Churn = new TeamKpiMetric { Score = e.ChurnScore, Status = e.ChurnStatus, Label = e.ChurnLabel, Trend = e.ChurnTrend, Description = e.ChurnDescription },
        Delivery = new TeamKpiMetric { Score = e.DeliveryScore, Status = e.DeliveryStatus, Label = e.DeliveryLabel, Trend = e.DeliveryTrend, Description = e.DeliveryDescription }
    };
