...
const ChartContainer = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    config: ChartConfig;
    children: React.ComponentProps<typeof RechartsTypes.ResponsiveContainer>["children"];
  }
  ...
  return (
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        <React.Suspense fallback={<div className="flex h-full w-full items-center justify-center">Loading chart...</div>}>
...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<typeof RechartsTypes.Tooltip> &
    React.ComponentProps<"div"> & {
      hideLabel?: boolean;
